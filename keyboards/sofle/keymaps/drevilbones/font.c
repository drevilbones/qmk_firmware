...
// stolen from here https://github.com/adafruit/Adafruit-GFX-Library/blob/master/glcdfont.c
// and modified to be closer to the standard 6x8 font included with QMK, but with
// all the extended glyphs of the original and without the logos
